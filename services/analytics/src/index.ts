...
async function bootstrap(): Promise<void> {
  console.info('[analytics] Starting FlowDesk Analytics Service...');
  ...
  app.listen(config.PORT, () => {
    console.info(`[analytics] Analytics service listening on port ${config.PORT} (${config.NODE_ENV})`);
  });
}

process.on('SIGTERM', async () => {
  console.info('[analytics] SIGTERM received. Shutting down gracefully...');
